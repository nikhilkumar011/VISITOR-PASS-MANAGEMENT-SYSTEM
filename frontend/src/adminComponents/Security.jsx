  ...
  return (
    <>
     <div className="flex mb-6">
        <SidenavA isVisible={isSidebarVisible}  />
        <Navbar
    ...
    {
      users.filter((each) => each.role === 'security').filter((each)=>(each.email).toLowerCase().includes(searchBarText.toLowerCase()))
        .map((each) => (
